...
const PersonalInfo: React.FC = () => {
  ...
  return (
    <div className="pb-24">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {DOSHAS.map((d) => (
                    <button
                      ...
                      className={`p-4 rounded-3xl transition-all border flex flex-col items-center gap-2 group ${dosha === d.title
                ...
                <div className="flex flex-wrap gap-2 px-2">
                  {WELLNESS_GOALS.map((goal) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-2xl text-xs font-bold transition-all border ${wellnessGoals.includes(goal.title)
                ...
                <div className="flex flex-wrap gap-2 px-2">
                  {HEALTH_CONDITIONS.map((cond) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-2xl text-xs font-bold transition-all border ${healthConditions.includes(cond.title)
      ...
      {/* Fixed Bottom Bar */}
      <div className="fixed bottom-[68px] lg:bottom-0 left-0 lg:left-60 right-0 bg-white border-t border-gray-100 p-2 z-40 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className={`px-10 py-4 rounded-[24px] font-bold transition-all flex items-center justify-center gap-3 shadow-xl ${showSuccess
